...
export default function ActivityCreate() {
  ...
  useEffect(() => { //Cada vex q se monta o actualixa el componente qioerp qie traiga todos los paises actualizado
  ...
  function handleSubmit(e){
    ...
    setInput({ //para que se ponga en 0, agarro todo y lo paso vacio
      name: "",
      difficulty: "",
      duration: "",
      season: "",
    ...
    <div>
      ...
      <form onSubmit = {(e) => handleSubmit(e)}>
        ...
        <div>
          ...
          <ul><li>{input.countries.map(el => el + ', ')} </li></ul> {/* renderiza cada cosa que voy marcando en el select */}
        </div>
